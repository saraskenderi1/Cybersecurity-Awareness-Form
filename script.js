...
async function sendResponsesToGoogleSheet() {
  ...
  const url = "https://script.google.com/macros/s/AKfycbz28bjEG-o_FiK1ocgsRinsezZJnIJnwikdRJW3exBebsq4ijJlQbBqpMZLX7Cx7fR_VQ/exec";
  ...
  try {
    ...
    if (result.status === "success") {
      ...
      console.error("Failed to save responses:", result.message);
    }
  } catch (error) {
